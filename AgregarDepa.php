...
<html lang="en">
<head> 
  <!-- Codigo que crear el formulario para insertar un departamento nuevo -->
    <meta charset="UTF-8">
          ...
          <nav class="menu d-flex d-sm-block justify-content-center flex-wrap">
            ...
            <form class="form" method="POST" action="InsertarDeptos.php">
                <div class="container">
                    ...
                    <button id="agregardepa" class="BotonGuardar" type="click" style="vertical-align: middle;">
            ...
            <script>cancelBtn.addEventListener('click', function() {
  Swal.fire({
