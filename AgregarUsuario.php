...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
          <div class="barra-lateral col-12 col-sm-auto">
            ...
            <form class="form" action="operauser.php" method="post" id="FormAdd">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <div style="text-align: center;">
                        <div style="display: inline-block;">
                          ...
                          <button id="cancelBtn" class="BotonGuardar" type="click" style="vertical-align: middle;">
    ...
    <script>const form = document.querySelector('#FormAdd');
...
<script src="https://code.jquery.com/jquery-3.5.1.slim.min.js"></script>
    ...
    <script src="js/Accionesjs/usuarios/agregar.js"></script> 
    <script src="js/Accionesjs/usuarios/btnCancelar.js"></script> 
    <script src="js/Accionesjs/usuario/btnEliminar.js"></script>
</body>
</html>
