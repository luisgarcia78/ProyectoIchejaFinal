        ...
        <div class="row justify-content-right align-content-center text-center">
          ...
          <form class="d-flex" role="search" style="width: 100%;">
            ...
            <div class="row" style="margin-left: 1%;">
              ...
              <div class="col-md-1" style="margin-left:20%; padding-left: 30%; text-align: justify; width: 100%;">
            ...
            <div class="row">
              <div class="col-md-1" style="margin-top: 13%; padding-right: 100px;">
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" value="" id="checkbox4">
                  <label class="form-check-label" for="checkbox4">
                    Dirección
          ...
          <div class="div_principa" style=" overflow: auto;position: sticky;max-height: 500px;" >
