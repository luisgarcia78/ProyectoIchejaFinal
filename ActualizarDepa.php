...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            // Validar que $id_usuario sea un valor numérico válido
            if (!is_numeric($id_usuario)) {
            // En caso de que no sea un valor numérico válido, asignar un valor por defecto
            $id_usuario = 0;
            ...
            $query = "SELECT * FROM usuarios";
                ...
                $options .= '<option value="' . $row['IdUsuario'] . '"';
                if ($row['IdUsuario'] == $id_usuario) {
                    $options .= ' selected';
                }
            ...
            // Convertir el valor a entero para evitar problemas de seguridad
            $id_usuario = intval($id_usuario);
            ?>

            <form class="form" method="POST" action="upadateDepa.php">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
